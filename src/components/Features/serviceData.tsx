...
const servicesData: Feature[] = [
  {
    ...
    icon: (
      <svg
        ...
        className="lucide lucide-grid-2x2-check text-white"
      >
    ...
    paragraph:
      "Identifying strengths, weaknesses, and opportunities through comprehensive assessments",
    btn: "Learn More",
    btnLink: "/diagnostics",
  },
  {
    ...
    paragraph:
      "Redefining operational frameworks for efficiency and scalability.",
    btn: "Learn More",
    btnLink: "/restructuring",
  },
  {
    id: 3,
    icon: (
    ...
    paragraph:
      "Crafting strategies to enhance brand visibility and customer engagement.",
    btn: "Learn More",
    btnLink: "/solutions",
  },
  {
    ...
    icon: (
      <svg
        ...
        stroke-linecap="round"
        stroke-linejoin="round"
        className="lucide lucide-library-big text-white"
      >
    ...
    paragraph:
      "Implementing sound financial systems for profitability and stability.",
    btn: "Learn More",
    btnLink: "/management",
  },
  {
    ...
    icon: (
      <svg
        ...
        stroke-linecap="round"
        stroke-linejoin="round"
        className="lucide lucide-expand text-white"
      >
        <path d="m15 15 6 6" />
        <path d="m15 9 6-6" />
    ...
    paragraph:
      "Equipping business owners and teams with the skills to innovate and excel.",
    btn: "Learn More",
    btnLink: "/training",
  },
];
